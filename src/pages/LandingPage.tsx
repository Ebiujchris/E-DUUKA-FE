...
const features = [
  {
    ...
    description: 'Track products, stock levels, and variants in real time. Never run out of your best sellers.',
  },
  {
    icon: '💰',
    title: 'Sales & Profit Tracking',
    description: 'Record every sale, calculate profit instantly, and see how your shop performs each day.',
  },
  {
    icon: '📋',
    title: 'Credit Management',
    description: 'Manage customer credit sales and payments. Keep tabs on who owes what.',
  },
  {
    icon: '📊',
    title: 'Reports & Analytics',
    description: 'Dashboard insights, expense tracking, and reports to grow your business smarter.',
  },
];

const steps = [
  { step: '01', title: 'Create your account', text: 'Register with your phone number and shop name in under a minute.' },
  { step: '02', title: 'Add your products', text: 'Set up inventory with prices, stock, and categories.' },
  { step: '03', title: 'Start selling', text: 'Record sales, track profit, and manage credits from anywhere.' },
];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden bg-slate-850 pt-28 pb-20 lg:pt-36 lg:pb-28">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -top-40 right-0 h-[500px] w-[500px] rounded-full bg-brand-500/20 blur-3xl" />
          <div className="absolute bottom-0 left-0 h-[400px] w-[400px] rounded-full bg-brand-400/10 blur-3xl" />
          <div
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            <div>
              ...
              <p className="mt-6 max-w-lg text-lg leading-relaxed text-slate-400">
                E-DUUKA is the all-in-one shop management platform for small retail businesses.
              ...
              <div className="rounded-2xl border border-slate-700/50 bg-slate-800/50 p-6 shadow-2xl backdrop-blur">
                ...
                <div className="space-y-4">
                  ...
                  <div className="rounded-xl bg-slate-700/30 p-4">
                    ...
                    {['Sugar 1kg × 3', 'Cooking Oil × 2', 'Soap × 5'].map((item) => (
                      <div
                        key={item}
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-slate-600">
              From inventory to insights — manage your entire business in one place.
            </p>
          </div>
      ...
      <section id="how-it-works" className="bg-slate-50 py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-slate-600">
              No complicated setup. Just register and start managing your shop.
            </p>
          </div>
      ...
      <footer className="border-t border-slate-100 py-12">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-6 sm:flex-row lg:px-8">
          <div className="flex items-center gap-2">
            ...
            <span className="font-display font-semibold text-slate-900">E-DUUKA</span>
          </div>
          <p className="text-sm text-slate-500">
            © {new Date().getFullYear()} E-DUUKA. Shop management for Uganda.
          </p>
        </div>
      </footer>
